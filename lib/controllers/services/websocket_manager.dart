...
class WebSocketManager {
  WebSocketChannel? channelPath;
  WebSocketChannel? channelEm;
  ...
  Future<void> openPathUpdateStream(String url) async {
    ...
    print("SONO IN APERTURA CANALE DI WEBSOCKET MANAGER PRIMA DI OPEN STREAM PER PATH__________________________________________________________________________");

    await _openStream(url, PathDTO.fromJson, _streamPathController, channelPath);
    print("SONO IN APERTURA CANALE DI WEBSOCKET MANAGER DOPO DI OPEN STREAM PER PATH__________________________________________________________________________");
